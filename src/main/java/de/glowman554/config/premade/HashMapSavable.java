...
public class HashMapSavable<T> extends HashMap<String, T> implements Savable {
    ...
    private final ArrayListSavable.ConstructorReference<T> constructorReference;

    public HashMapSavable(JsonProcessor processor, ArrayListSavable.ConstructorReference<T> constructorReference) {
    ...
    public HashMapSavable(Class<T> clazz, ArrayListSavable.ConstructorReference<T> constructorReference) {
